...
#define LPCD_TIMER3_CFG  	  	25	//LPCD检测阶段时间设置12
...
#define	LPCD_TIMER_VMID_CFG		30	//VMID准备时间设置
//0 = 0ms；1 = 0ms；2 = 0.4ms；3 = 0.5ms；4 = 0.6ms；5 = 0.7ms；6 = 0.8ms；7 = 0.9ms；8 = 1.0ms；
//9 = 1.1ms；10 = 1.2ms；11 = 1.3ms；12 = 1.4ms；13 = 1.5ms；14 = 1.6ms；15 = 1.7ms；16 = 1.8ms；
//17 = 1.9ms；18 = 2.0ms；19 = 2.1ms；20 = 2.2ms；21 = 2.3ms；22 = 2.4ms；23 = 2.5ms；24 = 2.6ms；
//25 = 2.7ms；26 = 2.8ms；27 = 2.9ms；28 = 3.0ms；29 = 3.1ms；30 = 3.2ms；31 = 3.3ms；

#define LPCD_TX2RF_EN		    1	//LPCD功能TX2发射输出使能
//0 = Disable；1 = Enable

#define	LPCD_AUTO_DETECT_TIMES  1   //LPCD检测次数设置       
//0 = 3次；1 = 1次

#define	LPCD_AUTO_WUP_EN		0   //自动校准使能    1   
//0 = Disable；1 = Enable

#define LPCD_AUTO_WUP_CFG		4   //自动校准时间设置   2    
